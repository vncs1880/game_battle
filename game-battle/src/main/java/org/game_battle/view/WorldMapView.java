...
/**
 * WorldMapView class to display the Continents,its control values countries and
 * their respective neighbours,connectivity of the countries and map edit
 * option.
 * 
 * @author basant
 * @version Alpha
...
public class WorldMapView {
	...
	/**
	 * setInputMapData sets the continents,control values and countries for the new
	 * map load
	 */
	...
	public void setInputMapData() {
		...
		System.out.println(
				"Enter country in format of country,x_cordinates, y_cordinates , continent , neighbours seperated in comma  ");
	 ...
	 * 
	 * @return isEditMap value to create a new map or load old map
	 */
	 ...
	 * 
	 * @return inputMapData user input data
	 */
